...
/*   Updated: 2019/09/08 19:35:57 by mwuckert         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define UNDEFINED_BEHAVIOR(arg) *arg == 'j' || *arg == 'z'
# define O_FORMAT(a) a##c, a##s, a##p, a##d, a##d, a##o, a##u, a##x, a##x, a##f
# define ARG(f) f##i, f##c, f##s, f##l, f##ll, f##u, f##uc, f##us, f##ul, f##ull
# define FUNC O_FORMAT(ft_format_), ft_format_basic, ARG(ft_varg_)
